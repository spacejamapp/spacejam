//! Heap-backed fixed-length array.
...
/// A fixed-length array backed by `Vec<T>` on the heap.
///
/// Wire format: N elements concatenated with no length prefix.
pub struct Array<T, const N: usize>(pub Vec<T>);

impl<T: ser::Serialize, const N: usize> ser::Serialize for Array<T, N> {
...
impl<'de, T: de::Deserialize<'de>, const N: usize> de::Deserialize<'de> for Array<T, N> {
    fn deserialize<D: de::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        impl<'de, T: de::Deserialize<'de>, const N: usize> Visitor<'de> for ArrayVisitor<T, N> {
            ...
            fn visit_seq<A: SeqAccess<'de>>(self, mut seq: A) -> Result<Self::Value, A::Error> {
                ...
                Array::try_from_vec(v).map_err(|_| A::Error::custom("length mismatch"))
            }
        }
...
impl<T: core::hash::Hash, const N: usize> core::hash::Hash for Array<T, N> {
