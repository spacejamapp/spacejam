...
pub const EXPUNGED_TIME: u32 = 19200;
...
/// (L) The maximum age of a lookup anchor (in timeslots, 24h at 6s slots).
pub const MAX_AGE_LOOKUP_ANCHOR: u32 = 14400;
...
pub const ROTATION_PERIOD: u16 = 10;

/// (V) The count of validators
pub const VALIDATORS_COUNT: u16 = 1023;
...
pub const TICKET_SUBMISSION_PERIOD: u32 = 500;

/// The number of validators in a super majority (ceil(V * 2/3 + 1))
pub const VALIDATORS_SUPER_MAJORITY: u16 = 683;

/// The number of bytes in the avail bitfield (floor((C + 7) / 8))
pub const AVAIL_BITFIELD_BYTES: usize = 43;
