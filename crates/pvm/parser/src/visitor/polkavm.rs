...
impl Visitor for Logger {
    ...
    fn visit_jump(&mut self, _format: format::O, _range: &Range<usize>) -> Result<()> {
        Ok(())
    }

    fn visit_jump_ind(&mut self, _format: format::RI, _range: &Range<usize>) -> Result<()> {
        Ok(())
    }
    ...
    fn visit_sbrk(&mut self, _format: format::RR, _range: &Range<usize>) -> Result<()> {
        Ok(())
    }
